...
public class Memorie2_7GB {
	...
	{
		logger.Log(LOG_FILE, "TestSmartphonesMemoie2.7GB(): Verifica optiunea de a afisa pe pagina doar produsele avand rezolutie foto 2.7 GB");
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr[3]/td[2]")).getText().contains(Constants.SMARTPHONE_2_7GB)==false)
				{
					logger.Log(LOG_FILE, "TestSmartphonesMemorie2.7GB(): TEST FAILLED !!!");
					h.screenShooter("TestSmartphonesMemorie2_7GB", d);
				}
				assertTrue(d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr[3]/td[2]")).getText().contains(Constants.SMARTPHONE_2_7GB));
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						logger.Log(LOG_FILE, "Numarul de produse avand rezolutie foto de"+Constants.SMARTPHONE_2_7GB+" sunt: "+k);
