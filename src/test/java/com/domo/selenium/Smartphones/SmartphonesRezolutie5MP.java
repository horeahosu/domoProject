...
public class SmartphonesRezolutie5MP {
	...
	public void TestSmartphonesMarcaApple() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestSmartphonesRezolutie5MP(): Wrong page TEST FAILED !!!");
		...
		if (h.isElementPresent(By.id("CB_3_5_Megapixeli"))==false)
		{
			logger.Log(LOG_FILE, "TestSmartphonesRezolutie5MP(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestSmartphonesRezolutie5MP", d);
		}
		assertTrue(h.isElementPresent(By.id("CB_3_5_Megapixeli"))==true);
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath(String.format(Constants.domo_product_details_2_xpath, i,j))).getText().contains(Constants.SMARTPHONE_5MP)==false)
				{
					logger.Log(LOG_FILE, "TestSmartphonesRezolutie5MP(): TEST FAILED !!!");
					h.screenShooter("TestSmartphonesRezolutie5MP", d);
				}
				assertTrue(d.findElement(By.xpath(String.format(Constants.domo_product_details_2_xpath, i,j))).getText().contains(Constants.SMARTPHONE_5MP));
				//procesez
