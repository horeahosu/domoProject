...
public class SmartphonesMemorie4GB {
	...
	{
		logger.Log(LOG_FILE, "TestSmartphonesMemoie4GB(): Verifica optiunea de a afisa pe pagina doar produsele avand memorie interna 4GB");
		...
		while (b!=true)
		{
			...
			{	
				...
				{ if (h.isElementPresent(By.id("NextPage2"))==true && (d.findElement(By.id("NextPage")).isDisplayed()==true))
					...
					{
						b=true;
						logger.Log(LOG_FILE, "Numarul de produse avand memorie interna de"+Constants.SMARTPHONE_4GB+" sunt: "+k);
