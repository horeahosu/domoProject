...
public class PretMaxim630 {
	...
	@Test
	public void TestPretMaxim630() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Sub_630_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(amount<Constants.PRET_630);
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul mai mic ca 630 sunt: "+k);
						i=3;
						j=1;
					}
				}
