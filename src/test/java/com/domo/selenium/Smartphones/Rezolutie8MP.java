...
public class Rezolutie8MP {
	...
	public void TestSmartphonesRezolutie8MP() throws InterruptedException, IOException
	{
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr[2]/td[2]")).getText().contains(Constants.SMARTPHONE_8MP)==false)
				{
					logger.Log(LOG_FILE, "TestSmartphonesRezolutie8MP(): TEST FAILLED !!!");
					h.screenShooter("TestSmartphonesRezolutie8MP", d);
				}
				assertTrue(d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr[2]/td[2]")).getText().contains(Constants.SMARTPHONE_8MP));
				//procesez
