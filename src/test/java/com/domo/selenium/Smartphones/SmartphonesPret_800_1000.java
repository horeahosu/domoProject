...
public class SmartphonesPret_800_1000 {
	...
	public void TestSmartphonesPret_800_1000() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestSmartphonesPret_800_1000(): Wrong page TEST FAILED !!!");
		...
		{
			logger.Log(LOG_FILE, "TestSmartphonesPret_800_1000(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestSmartphonesPret_800_1000", d);
		}
		...
		while (b!=true)
		{
			...
			{	
				...
				{
					logger.Log(LOG_FILE, "TestSmartphonesPret_800_1000(): A product with non coresponding price was found TEST FAILED !!!");
					h.screenShooter("TestSmartphonesPret_800_1000", d);
				}
