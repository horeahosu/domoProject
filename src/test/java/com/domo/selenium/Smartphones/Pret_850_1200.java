...
public class Pret_850_1200 {
	...
	@Test
	public void TestPret_850_1200() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Intre_850_-_1.200_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(Constants.PRET_850<amount);
				assertTrue(amount<Constants.PRET_1200);
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul intre 850 si 1200 sunt: "+k);
						i=3;
						j=1;
					}
				}
