...
public class Pret_630_850 {
	...
	@Test
	public void TestPret_630_850() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Intre_630_-_850_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(Constants.PRET_630<amount);
				assertTrue(amount<Constants.PRET_850);
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul intre 630 si 850 sunt: "+k);
						i=3;
						j=1;
					}
				}
