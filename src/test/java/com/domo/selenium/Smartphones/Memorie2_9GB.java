...
public class Memorie2_9GB {
	...
	{
		logger.Log(LOG_FILE, "TestSmartphonesMemoie2.9GB(): Verifica optiunea de a afisa pe pagina doar produsele avand rezolutie foto 2.9 GB");
		...
		{
			logger.Log(LOG_FILE, "TestSmartphonesMemorie2.9GB(): Wrong page TEST FAILLED !!!");
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr[3]/td[2]")).getText().contains(Constants.SMARTPHONE_2_9GB)==false)
				{
					logger.Log(LOG_FILE, "TestSmartphonesMemorie2.9GB(): TEST FAILLED !!!");
					h.screenShooter("TestSmartphonesMemorie2_9GB", d);
				}
				assertTrue(d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr[3]/td[2]")).getText().contains(Constants.SMARTPHONE_2_9GB));
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						logger.Log(LOG_FILE, "Numarul de produse avand rezolutie foto de"+Constants.SMARTPHONE_2_9GB+" sunt: "+k);
