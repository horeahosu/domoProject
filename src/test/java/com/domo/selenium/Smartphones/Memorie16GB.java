...
public class Memorie16GB {
	...
	public void TestSmartphonesMemoie16GB() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestSmartphonesMemorie16GB(): Wrong page TEST FAILLED !!!");
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/div[2]/table/tbody/tr[2]/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr[3]/td[2]")).getText().contains(Constants.SMARTPHONE_16GB)==false)
				{
					logger.Log(LOG_FILE, "TestSmartphonesMemorie16GB(): TEST FAILLED !!!");
					h.screenShooter("TestSmartphonesMemorie16GB", d);
				}
				assertTrue(d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/div[2]/table/tbody/tr[2]/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr[3]/td[2]")).getText().contains(Constants.SMARTPHONE_16GB));
				//procesez
