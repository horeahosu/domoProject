...
public class MarcaSony {
	...
	/**
	 * TestSmartphonesMarcaSony(): Verifica optiunea de a afisa pe pagina doar produsele avand marca Sony Vaio
	 * 
	 */
	
	@Test
	public void TestSmartphonesMarcaSony() throws InterruptedException, IOException
	{
		logger.Log(LOG_FILE, "TestSmartphonesMarcaSony(): Verifica optiunea de a afisa pe pagina doar produsele avand marca Sony");
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/a[2]/strong")).getText().contains(Constants.MARCA_SONY)==false)
				{
					logger.Log(LOG_FILE, "TestSmartphonesMarcaSony(): Wrong page TEST FAILLED !!!");
					h.screenShooter("TestSmartphonesMarcaSony", d);
				}
				assertTrue(d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/a[2]/strong")).getText().contains(Constants.MARCA_SONY));
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					else
					{
						...
						logger.Log(LOG_FILE, "TestSmartphonesMarcaSony(): TEST PASSED");
						i=1;
						j=1;
					}
				}
