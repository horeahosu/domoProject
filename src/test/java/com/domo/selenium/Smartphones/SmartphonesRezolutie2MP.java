...
public class SmartphonesRezolutie2MP {
	...
	/**
	 * TestSmartphonesRezolutie2MP(): Verifica optiunea de a afisa pe pagina doar produsele avand rezolutie foto 2MP
	 * 
	 */
	
	@Test
	public void TestSmartphonesRezolutie2MP() throws InterruptedException, IOException
	{
		logger.Log(LOG_FILE, "TestSmartphonesRezolutie2MP(): Verifica optiunea de a afisa pe pagina doar produsele avand rezolutie foto 2MP");
		...
		{
			logger.Log(LOG_FILE, "TestSmartphonesRezolutie2MP(): Wrong page TEST FAILED !!!");
		...
		{
			logger.Log(LOG_FILE, "TestSmartphonesRezolutie2MP(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestSmartphonesRezolutie2MP", d);
		}
		...
		while (b!=true)
		{
			...
			{	
				...
				{
					logger.Log(LOG_FILE, "TestSmartphonesRezolutie2MP(): TEST FAILED !!!");
					h.screenShooter("TestSmartphonesRezolutie2MP", d);
				}
				...
				{ if (h.isElementPresent(By.id("NextPage2"))==true && (d.findElement(By.id("NextPage")).isDisplayed()==true))
					...
					{
						b=true;
						logger.Log(LOG_FILE, "Numarul de produse avand rezolutie foto de"+Constants.SMARTPHONE_2MP+" sunt: "+k);
						logger.Log(LOG_FILE, "TestSmartphonesRezolutie2MP(): TEST PASSED");
						i=1;
						j=1;
					}
				}
