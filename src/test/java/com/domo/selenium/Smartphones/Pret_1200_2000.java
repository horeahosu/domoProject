...
public class Pret_1200_2000 {
	...
	@Test
	public void TestPret_1200_2000() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Intre_1.200_-_2.000_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(Constants.PRET_1200<amount);
				assertTrue(amount<Constants.PRET_2000);
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul intre 1200 si 2000 sunt: "+k);
						i=3;
						j=1;
					}
				}
