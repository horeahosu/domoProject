...
public class SmartphonesRezolutie3_15MP {
	...
	public void TestSmartphonesRezolutie3_15MP() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestSmartphonesRezolutie3.15MP(): Wrong page TEST FAILED !!!");
		...
		{
			logger.Log(LOG_FILE, "TestSmartphonesRezolutie3.15MP(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestSmartphonesRezolutie3_15MP", d);
		}
		...
		while (b!=true)
		{
			...
			{	
				...
				{
					logger.Log(LOG_FILE, "TestSmartphonesRezolutie3.15MP(): TEST FAILED !!!");
					h.screenShooter("TestSmartphonesRezolutie3_15MP", d);
				}
