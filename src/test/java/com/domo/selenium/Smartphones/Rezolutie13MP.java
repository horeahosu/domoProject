...
public class Rezolutie13MP {
	...
	public void TestSmartphonesRezolutie3MP() throws InterruptedException, IOException
	{
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr[2]/td[2]")).getText().contains(Constants.SMARTPHONE_13MP)==false)
				{
					logger.Log(LOG_FILE, "TestSmartphonesRezolutie13MP(): TEST FAILLED !!!");
					h.screenShooter("TestSmartphonesRezolutie13MP", d);
				}
				assertTrue(d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr[2]/td[2]")).getText().contains(Constants.SMARTPHONE_13MP));
				//procesez
