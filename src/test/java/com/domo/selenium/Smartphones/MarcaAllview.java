...
public class MarcaAllview {
	...
	public void TestSmartphonesMarcaAllview() throws InterruptedException, IOException
	{
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/a[2]/strong")).getText().contains(Constants.SMARTPHONE_ALLVIEW)==false)
				{
					logger.Log(LOG_FILE, "TestSmartphonesMarcaAllview(): TEST FAILLED !!!");
					h.screenShooter("TestSmartphonesMarcaAllview", d);
				}
				assertTrue(d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/a[2]/strong")).getText().contains(Constants.SMARTPHONE_ALLVIEW));
				//procesez
