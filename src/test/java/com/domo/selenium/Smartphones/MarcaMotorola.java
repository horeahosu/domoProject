...
public class MarcaMotorola {
	...
	/**
	 * TestSmartphonesMarcaMotorola(): Verifica optiunea de a afisa pe pagina doar produsele avand marca Motorola
	 * 
	 */
	...
	{
		logger.Log(LOG_FILE, "TestSmartphonesMarcaMotorola(): Verifica optiunea de a afisa pe pagina doar produsele avand marca Motorola");
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/a[2]/strong")).getText().contains(Constants.SMARTPHONE_MOTOROLA)==false)
				{
					logger.Log(LOG_FILE, "TestSmartphonesMarcaMotorola(): TEST FAILLED !!!");
					h.screenShooter("TestSmartphonesMarcaMotorola", d);
				}
				assertTrue(d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/a[2]/strong")).getText().contains(Constants.SMARTPHONE_MOTOROLA));
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						logger.Log(LOG_FILE, "Numarul de produse "+Constants.SMARTPHONE_MOTOROLA+" sunt: "+k);
						logger.Log(LOG_FILE, "TestSmartphonesMarcaMotorola(): TEST PASSED");
						i=1;
						j=1;
					}
				}
