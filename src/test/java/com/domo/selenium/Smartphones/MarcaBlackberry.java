...
public class MarcaBlackberry {
	...
	public void TestSmartphonesMarcaApple() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestSmartphonesMarcaBlackberry(): Wrong page TEST FAILLED !!!");
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/a[2]/strong")).getText().contains(Constants.SMARTPHONE_BLACKBERRY)==false)
				{
					logger.Log(LOG_FILE, "TestSmartphonesMarcaBlackberry(): TEST FAILLED !!!");
					h.screenShooter("TestSmartphonesMarcaBlackberry", d);
				}
				assertTrue(d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/a[2]/strong")).getText().contains(Constants.SMARTPHONE_BLACKBERRY));
				//procesez
