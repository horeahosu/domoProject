...
public class TVLEDDiagonala_81 {
	...
	public void TestDiagonala_81() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestTVLEDDiagonala81(): Wrong page TEST FAILED !!!");
		...
		if (h.isElementPresent(By.id("CB_2_81_cm"))==false)
		{
			logger.Log(LOG_FILE, "TestTVLEDDiagonala81(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestTVLEDDiagonala81", d);
		}
		assertTrue(h.isElementPresent(By.id("CB_2_81_cm"))==true);
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath(String.format(Constants.domo_product_details_1_xpath, i,j))).getText().contains(Constants.DIAGONALA_81)==false)
				{
					logger.Log(LOG_FILE, "TestTVLEDDiagonala81(): TEST FAILED !!!");
					h.screenShooter("TestTVLEDDiagonala81", d);
				}
				assertTrue(d.findElement(By.xpath(String.format(Constants.domo_product_details_1_xpath, i,j))).getText().contains(Constants.DIAGONALA_81));
				//procesez
