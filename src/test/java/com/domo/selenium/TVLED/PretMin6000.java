...
public class PretMin6000 {
	...
	@Test
	public void TestPretMaxim1500() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Peste_6.000_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul mai mare ca 6000 sunt: "+k);
						i=3;
						j=1;
					}
				}
