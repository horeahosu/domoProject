...
public class TVLEDDiagonala_102 {
	...
	public void TestTVLEDDiagonala_102() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestTVLEDDiagonala102(): Wrong page TEST FAILED !!!");
		...
		if (h.isElementPresent(By.id("CB_2_102_cm"))==false)
		{
			logger.Log(LOG_FILE, "TestTVLEDDiagonala102(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestTVLEDDiagonala102", d);
		}
		assertTrue(h.isElementPresent(By.id("CB_2_102_cm"))==true);
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath(String.format(Constants.domo_product_details_1_xpath, i,j))).getText().contains(Constants.DIAGONALA_102)==false)
				{
					logger.Log(LOG_FILE, "TestTVLEDDiagonala102(): TEST FAILED !!!");
					h.screenShooter("TestTVLEDDiagonala102", d);
				}
				assertTrue(d.findElement(By.xpath(String.format(Constants.domo_product_details_1_xpath, i,j))).getText().contains(Constants.DIAGONALA_102));
				//procesez
