...
public class Diagonala_66 {
	...
	public void TestDiagonala_107() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestTVLEDDiagonala66(): Wrong page TEST FAILLED !!!");
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath("html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr/td[2]")).getText().contains(Constants.DIAGONALA_66)==false)
				{
					logger.Log(LOG_FILE, "TestTVLEDDiagonala66(): TEST FAILLED !!!");
					h.screenShooter("TestTVLEDDiagonala66", d);
				}
				assertTrue(d.findElement(By.xpath("html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr/td[2]")).getText().contains(Constants.DIAGONALA_66));
				//procesez
