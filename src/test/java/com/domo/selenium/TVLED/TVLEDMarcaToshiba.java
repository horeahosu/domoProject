...
public class TVLEDMarcaToshiba {
	...
	public void TestTVLEDMarcaToshiba() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestTVLEDMarcaToshiba(): Wrong page TEST FAILED !!!");
		...
		{
			logger.Log(LOG_FILE, "TestTVLEDMarcaToshiba(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestTVLEDMarcaToshiba", d);
		}
		...
		while (b!=true)
		{
			...
			{	
				...
				{
					logger.Log(LOG_FILE, "TestTVLEDMarcaToshiba(): TEST FAILED !!!");
					h.screenShooter("TestTVLEDMarcaToshiba", d);
				}
