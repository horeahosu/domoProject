...
public class TVLEDDiagonala_56 {
	...
	public void TestDiagonala_56() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestTVLEDDiagonala56(): Wrong page TEST FAILED !!!");
		...
		if (h.isElementPresent(By.id("CB_2_56_cm"))==false)
		{
			logger.Log(LOG_FILE, "TestTVLEDDiagonala56(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestTVLEDDiagonala56", d);
		}
		assertTrue(h.isElementPresent(By.id("CB_2_56_cm"))==true);
		...
		while (b!=true)
		{
			...
			{	
				...
				{
					logger.Log(LOG_FILE, "TestTVLEDDiagonala56(): TEST FAILED !!!");
					h.screenShooter("TestTVLEDDiagonala56", d);
				}
