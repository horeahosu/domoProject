...
public class Pret_3600_6000 {
	...
	@Test
	public void TestPret_3600_6000() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Intre_3.600_-_6.000_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(amount>Constants.PRET_3600);
				assertTrue(amount<Constants.PRET_6000);
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul intre 3600 si 6000 sunt: "+k);
						i=3;
						j=1;
					}
				}
