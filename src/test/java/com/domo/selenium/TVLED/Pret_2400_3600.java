...
public class Pret_2400_3600 {
	...
	@Test
	public void TestPret_2400_3600() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Intre_2.400_-_3.600_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul intre 2400 si 3600 sunt: "+k);
						i=3;
						j=1;
					}
				}
