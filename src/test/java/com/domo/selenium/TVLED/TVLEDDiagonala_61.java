...
public class TVLEDDiagonala_61 {
	...
	/**
	 * TestTVLEDDiagonala_61(): Verifica optiunea de a afisa pe pagina doar produsele avand diagonala: 61
	 * 
	 */
	
	@Test
	public void TestDiagonala_61() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestTVLEDDiagonala61(): Wrong page TEST FAILED !!!");
		...
		if (h.isElementPresent(By.id("CB_2_61_cm"))==false)
		{
			logger.Log(LOG_FILE, "TestTVLEDDiagonala61(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestTVLEDDiagonala61", d);
		}
		assertTrue(h.isElementPresent(By.id("CB_2_61_cm"))==true);
		
		d.findElement(By.id("CB_2_61_cm")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				{
					logger.Log(LOG_FILE, "TestTVLEDDiagonala61(): TEST FAILED !!!");
					h.screenShooter("TestTVLEDDiagonala61", d);
				}
				...
				{ if (h.isElementPresent(By.id("NextPage2"))==true && (d.findElement(By.id("NextPage")).isDisplayed()==true))
					...
					{
						b=true;
						logger.Log(LOG_FILE, "Numarul de produse avand diagonala "+Constants.DIAGONALA_61+" sunt: "+k);
						logger.Log(LOG_FILE, "TestTVLEDDiagonala61(): TEST PASSED");
						i=3;
						j=1;
					}
				}
