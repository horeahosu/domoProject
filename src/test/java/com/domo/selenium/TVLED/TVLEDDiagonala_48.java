...
public class TVLEDDiagonala_48 {
	...
	public void TestTVLEDDiagonala_48() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestTVLEDDiagonala48(): Wrong page TEST FAILED !!!");
		...
		if (h.isElementPresent(By.id("CB_2_48_cm"))==false)
		{
			logger.Log(LOG_FILE, "TestTVLEDDiagonala48(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestTVLEDDiagonala48", d);
		}
		assertTrue(h.isElementPresent(By.id("CB_2_48_cm"))==true);
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath(String.format(Constants.domo_product_details_1_xpath, i,j))).getText().contains(Constants.DIAGONALA_48)==false)
				{
					logger.Log(LOG_FILE, "TestTVLEDDiagonala48(): TEST FAILED !!!");
					h.screenShooter("TestTVLEDDiagonala48", d);
				}
				assertTrue(d.findElement(By.xpath(String.format(Constants.domo_product_details_1_xpath, i,j))).getText().contains(Constants.DIAGONALA_48));
				//procesez
