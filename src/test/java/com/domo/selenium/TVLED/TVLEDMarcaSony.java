...
public class TVLEDMarcaSony {
	...
	public void TestTVLEDMarcaSony() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestTVLEDMarcaSony(): Wrong page TEST FAILED !!!");
		...
		{
			logger.Log(LOG_FILE, "TestTVLEDMarcaSony(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestTVLEDMarcaSony", d);
		}
		...
		while (b!=true)
		{
			...
			{	
				...
				{
					logger.Log(LOG_FILE, "TestTVLEDMarcaSony(): TEST FAILED !!!");
					h.screenShooter("TestTVLEDMarcaSony", d);
				}
