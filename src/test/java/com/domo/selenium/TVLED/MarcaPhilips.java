...
public class MarcaPhilips {
	...
	@Test
	public void TestMarcaPhilips() throws InterruptedException, IOException
	{
		...
		while (b!=true)
		{
			...
			{	
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse "+Constants.MARCA_PHILIPS+" sunt: "+k);
						i=1;
						j=1;
					}
				}
