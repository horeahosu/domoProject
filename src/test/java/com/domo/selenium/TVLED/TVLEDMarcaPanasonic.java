...
public class TVLEDMarcaPanasonic {
	...
	public void TestTVLEDMarcaPanasonic() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestTVLEDMarcaPanasonic(): Wrong page TEST FAILED !!!");
		...
		if (h.isElementPresent(By.id("CB_0_Panasonic"))==false)
		{
			logger.Log(LOG_FILE, "TestTVLEDMarcaPanasonic(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestTVLEDMarcaPanasonic", d);
		}
		assertTrue(h.isElementPresent(By.id("CB_0_Panasonic"))==true);
		...
		while (b!=true)
		{
			...
			{	
				...
				{
					logger.Log(LOG_FILE, "TestTVLEDMarcaPanasonic(): TEST FAILED !!!");
					h.screenShooter("TestTVLEDMarcaPanasonic", d);
				}
