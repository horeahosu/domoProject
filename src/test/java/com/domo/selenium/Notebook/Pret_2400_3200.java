...
public class Pret_2400_3200 {
	...
	@Test
	public void TestPret_2400_3200() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Intre_2.400_-_3.200_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(Constants.PRET_2400<amount);
				assertTrue(amount<Constants.PRET_3200);
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul intre 2400 si 3200 sunt: "+k);
						i=3;
						j=1;
					}
				}
