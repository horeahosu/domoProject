...
public class NotebookDiagonala_15_5 {
	...
	public void TestNotebookDiagonala15_5() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestNotebookDiagonala15_5(): Wrong page TEST FAILED !!!");
		...
		if (h.isElementPresent(By.id("CB_3_15.5``"))==false)
		{
			logger.Log(LOG_FILE, "TestNotebookDiagonala15_5(): Option is not available TEST FAILED !!!");
			h.screenShooter("TestNotebookDiagonala15_5", d);
		}
		assertTrue(h.isElementPresent(By.id("CB_3_15.5``"))==true);
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath(String.format(Constants.domo_product_details_2_xpath, i,j))).getText().contains(Constants.DIAGONALA_15_5)==false)
				{
					logger.Log(LOG_FILE, "TestNotebookDiagonala15_5(): TEST FAILED !!!");
					h.screenShooter("TestNotebookDiagonala15_5", d);
				}
				assertTrue(d.findElement(By.xpath(String.format(Constants.domo_product_details_2_xpath, i,j))).getText().contains(Constants.DIAGONALA_15_5));
				//procesez
