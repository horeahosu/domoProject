...
public class PretMaxim1900 {
	...
	@Test
	public void TestPretMaxim1900() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Sub_1.900_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(amount<Constants.PRET_MAX_1900);
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul mai mic ca 1900 sunt: "+k);
						i=3;
						j=1;
					}
				}
