...
public class Pret_1900_2400 {
	...
	@Test
	public void TestPret_1900_2400() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Intre_1.900_-_2.400_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(Constants.PRET_MAX_1900<amount);
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul intre 1900 si 2400 sunt: "+k);
						i=3;
						j=1;
					}
				}
