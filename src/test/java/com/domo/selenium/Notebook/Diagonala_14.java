...
public class Diagonala_14 {
	...
	public void TestNotebookDiagonala14() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestNotebookDiagonala14(): Wrong page TEST FAILLED !!!");
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath("html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr[2]/td[2]")).getText().contains(Constants.DIAGONALA_14)==false)
				{
					logger.Log(LOG_FILE, "TestNotebookDiagonala14(): TEST FAILLED !!!");
					h.screenShooter("TestNotebookDiagonala14", d);
				}
				assertTrue(d.findElement(By.xpath("html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/table/tbody/tr[2]/td[2]")).getText().contains(Constants.DIAGONALA_14));
				//procesez
