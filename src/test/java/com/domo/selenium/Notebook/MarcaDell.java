...
public class MarcaDell {
	...
	public void TestNotebookMarcaDell() throws InterruptedException, IOException
	{
		...
		{
			logger.Log(LOG_FILE, "TestNotebookMarcaDell(): Wrong page TEST FAILLED !!!");
		...
		while (b!=true)
		{
			...
			{	
				//procesez
				if (d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/a[2]/strong")).getText().contains(Constants.MARCA_DELL)==false)
				{
					logger.Log(LOG_FILE, "TestNotebookMarcaDell(): TEST FAILLED !!!");
					h.screenShooter("TestNotebookMarcaDell", d);
				}
				assertTrue(d.findElement(By.xpath("/html/body/div/div[3]/div/div[2]/form/span[2]/table/tbody/tr/td/table/tbody/tr["+i+"]/td["+j+"]/a[2]/strong")).getText().contains(Constants.MARCA_DELL));
				//procesez
