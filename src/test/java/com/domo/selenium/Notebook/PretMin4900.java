...
public class PretMin4900 {
	...
	@Test
	public void TestPretMin4900() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Peste_4.900_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(Constants.PRET_4900<amount);
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul mai mare decat 4900 sunt: "+k);
						i=3;
						j=1;
					}
				}
