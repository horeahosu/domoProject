...
public class Pret_3200_4900 {
	...
	@Test
	public void TestPret_3200_4900() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Intre_3.200_-_4.900_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(Constants.PRET_3200<amount);
				assertTrue(amount<Constants.PRET_4900);
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul intre 3200 si 4900 sunt: "+k);
						i=3;
						j=1;
					}
				}
