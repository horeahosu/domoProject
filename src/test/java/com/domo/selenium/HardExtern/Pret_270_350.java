...
public class Pret_270_350 {
	...
	/**
	 * TestHardExterPret270_350(): Verifica optiunea de a afisa pe pagina doar produsele avand pretul intre 270 si 350
	 * 
	 */
	
	@Test
	public void TestHardExternPret270_350() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Intre_270_-_350_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(Constants.PRET_270<amount);
				assertTrue(amount<Constants.PRET_350);
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul intre 270 si 350 sunt: "+k);
						i=3;
						j=1;
					}
				}
