...
public class HardExternPretMin390 {
	...
	/**
	 * TestHardexternPretMin390(): Verifica optiunea de a afisa pe pagina doar produsele avand pretul mai mare de 390
	 * 
	 */
	
	@Test
	public void TestHardexternPretMin390() throws InterruptedException, IOException
	{
		
		//verific daca sunt pe site-ul bun
		logger.Log(LOG_FILE, "TestHardexternPretMin390(): Verifica optiunea de a afisa pe pagina doar produsele avand pretul mai mare de 390");
		h.waitForElementPresent(By.xpath(Constants.domo_product_first_title_xpath), 5);
		if (d.findElement(By.xpath(Constants.domo_product_first_title_xpath)).getText().contains("Hard")==false)
		{
			logger.Log(LOG_FILE, "TestHardexternPretMin390(): Wrong page TEST FAILLED !!!");
		...
		d.findElement(By.id("CB_1_Peste_390_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				{ if (h.isElementPresent(By.id("NextPage2"))==true && (d.findElement(By.id("NextPage")).isDisplayed()==true))
					...
					{
						b=true;
						logger.Log(LOG_FILE, "Numarul de produse avand pretul mai mare de 360 sunt: "+k);
						logger.Log(LOG_FILE, "TestHardexternPretMin390(): TEST PASSED");
						i=3;
						j=1;
					}
				}
