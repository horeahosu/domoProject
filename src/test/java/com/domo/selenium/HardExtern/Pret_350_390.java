...
public class Pret_350_390 {
	...
	/**
	 * TestHardExterPret350_390(): Verifica optiunea de a afisa pe pagina doar produsele avand pretul intre 360 si 390
	 * 
	 */
	
	@Test
	public void TestHardExternPret360_390() throws InterruptedException, IOException
	{
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(Constants.PRET_350<amount);
				assertTrue(amount<Constants.PRET_390);
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul intre 350 si 390 sunt: "+k);
						i=3;
						j=1;
					}
				}
