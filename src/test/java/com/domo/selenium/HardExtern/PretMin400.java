...
public class PretMin400 {
	...
	/**
	 * TestHardExterPretMin400(): Verifica optiunea de a afisa pe pagina doar produsele avand pretul mai mic de 400
	 * 
	 */
	
	@Test
	public void TestHardExternPretMin400() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Peste_400_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul mai mare ca 400 sunt: "+k);
						i=3;
						j=1;
					}
				}
