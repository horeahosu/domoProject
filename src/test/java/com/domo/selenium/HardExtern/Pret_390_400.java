...
public class Pret_390_400 {
	...
	/**
	 * TestHardExterPret390_400(): Verifica optiunea de a afisa pe pagina doar produsele avand pretul intre 390 si 400
	 * 
	 */
	
	@Test
	public void TestHardExterPret390_400() throws InterruptedException, IOException
	{
		...
		//sub 1900
		d.findElement(By.id("CB_1_Intre_390_-_400_lei")).click();
		Thread.sleep(2000);
		...
		while (b!=true)
		{
			...
			{	
				...
				assertTrue(Constants.PRET_390<amount);
				assertTrue(amount<Constants.PRET_400);
				//procesez
				...
				{ if (d.findElement(By.id("NextPage")).isDisplayed()==true)
					...
					{
						b=true;
						System.out.println("Numarul de produse avand pretul intre 390 si 400 sunt: "+k);
						i=3;
						j=1;
					}
				}
